...
export const altCatalog: Record<string, AltDetail> = {
  ...
  "crunch-polea": {
    ...
    desc: "Abdomen con placas en el multifuncional, para cuando la máquina de abdominales esté ocupada.",
    steps: [
    ...
    exercises: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Encorva las costillas hacia la cadera al exhalar — <b>jala el abdomen, no los brazos</b>.",
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        reps: "1 a 1",
        desc: "<b>Personalizada: el profe dirige calentamiento, estiramiento, técnica y todo el trabajo.</b> Tu único trabajo es llegar fresco, escuchar y dejarlo todo adentro. Pídele que meta <b>trabajo de cuello</b> de vez en cuando: en MMA importa.",

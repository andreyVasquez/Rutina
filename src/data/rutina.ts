...
export interface DayData {
  ...
  title: string;
  quote?: string;
  /** Día 4 usa una grilla de recuperación (.recov) en vez de .cards. */
  recovery?: boolean;
  exercises: Exercise[];
}
...
export const days: DayData[] = [
    ...
    exercises: [
      {
        ...
        reps: "12–15 min",
        desc: "Elíptica (o cuerda 10 min) + 2 min de banda para hombro.",
        watch: "Elíptica",
      },
      {
        icon: "i-shadow",
        ...
        reps: "3 rds × 3 min",
        desc: "<b>En fresco.</b> Foco en 1-2 (jab, cross), extiende bien y rota el torso. Sin mancuernas.",
        watch: "Kickboxing",
      },
      {
        icon: "i-pulldown",
      ...
      {
        icon: "i-row",
        title: "Remo con mancuerna / máquina",
        reps: "4 × 10",
      ...
      {
        icon: "i-facepull",
        title: "Face pull / band pull-apart",
        reps: "3 × 15",
  ...
  },
  {
    ...
    num: "02",
    kicker: "Día 2",
    title: "Empuje, Hombros y Striking Frontal",
    exercises: [
      {
        icon: "i-rope",
        title: "Cardio + movilidad",
        reps: "12–15 min",
        desc: "Elíptica / cuerda + banda de hombro.",
        watch: "Elíptica",
      },
      {
        icon: "i-plyo",
      ...
      {
        icon: "i-chestpress",
        title: "Press de pecho (máquina / mancuerna)",
        reps: "4 × 8–10",
        desc: "<b>RIR 1–2.</b>",
        watch: "Fuerza tradicional",
      },
    ...
    exercises: [
      {
        ...
        title: "Cardio + movilidad",
        reps: "12–15 min",
        desc: "Elíptica / cuerda + movilidad de cadera.",
        watch: "Elíptica",
      },
      {
        icon: "i-goblet",
      ...
      },
      {
        ...
        reps: "3 × 12",
        desc: "Degradado a accesorio; aprieta arriba.",
        watch: "Fuerza tradicional",
      },
      {
        icon: "i-chop",
        title: "Leñador con polea / banda (woodchop)",
        reps: "3 × 12 / lado",
      ...
      {
        icon: "i-pallof",
        title: "Pallof press (anti-rotación)",
        reps: "3 × 12 / lado",
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        title: "Técnica",
        reps: "15 min",
        desc: "Shadow boxing libre frente al espejo: postura, esquivas, manos arriba.",
        watch: "Kickboxing",
      },
      {
        icon: "i-stretch",
        title: "Extra",
        reps: "5–8 min",
        desc: "Movilidad de hombro, cadera y columna torácica. <b>Esto es lo que te mantiene sin lesiones</b> golpeando 3–4 días por semana.",
        watch: "Flexibilidad",
      },
    ],
  },
  {
    ...
    num: "05",
    kicker: "Día 5",
    title: "Empuje Vertical y Saco",
    exercises: [
      {
        icon: "i-rope",
        title: "Cardio",
        reps: "10 min",
        desc: "Cuerda o elíptica, suave (es calentamiento).",
        watch: "Cuerda",
      },
      {
        icon: "i-bag",
        title: "Saco / shadow alta intensidad",
        reps: "5 rds × 3 min",
        desc: "<b>Primero, en fresco:</b> rectos, ganchos, combinaciones. Es la prioridad del día.",
        watch: "Kickboxing",
      },
      {
        icon: "i-ohp",
        ...
        reps: "4 × 8–10",
        desc: "Algo más ligero: el saco ya pre-fatigó el hombro (compromiso del híbrido).",
        watch: "Fuerza tradicional",
      },
      {
        icon: "i-pulldown",
